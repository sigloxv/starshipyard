...
// TODO: Should be using bytes, ints and anything at all but strings
const (
	tagID        = "id"
	tagIdx       = "index"
	tagUniqueIdx = "unique"
	...
	indexPrefix  = "__shiphold_index_" // TODO: Seems like longer strings would be slower intuitively speaking
)
...
// TODO: Determine what we are using from reflect and either build our own
// limited reflect library or look for one that alreadye xist that can satisfy
// what we need without the debugging aspects and unsafe code
